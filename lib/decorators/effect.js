...
function effect(options) {
    return function (target, propertyKey, descriptor) {
        var func = function (action, effects) {
            var namespace, currentThis, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [5 /*yield**/, __values(descriptor.value.apply(currentThis, action.payload))];
                    case 1:
                        result = _a.sent();
        ...
        var targetFunc = options ? [func, options] : func;
        if (!metadata.has(EFFECTS, target)) {
            metadata.define(EFFECTS, {}, target);
        }
        var effects = metadata.get(EFFECTS, target);
